...
echo "Releasing ligo-config: $LATEST → $VERSION"
...
gh release create "$VERSION" --repo linkeunid/ligo-config --title "$VERSION" --notes "" --latest

echo "Released ligo-config $VERSION"
